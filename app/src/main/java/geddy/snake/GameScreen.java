...
import geddy.snake.framework.Input.TouchEvent;
...
public class GameScreen extends Screen {
    ...
    private void drawWorld(World world){
        ...
        //here add draws moving for the AI don't forget to assign the x and y of the AI;
    ...
    private void drawPausedUI(){
        ...
        g.drawPixmap(Assets.pause,80,120);
        g.drawLine(0,416,480,416, Color.BLACK);
    }
